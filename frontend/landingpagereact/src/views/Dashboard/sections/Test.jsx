...
function createData(
  ...
  // const rows = [
  //   createData("Patient Zero", 1,6, 148, 72, 35, 0, 33.6, 0.627, 50, 1),
  //   createData("Patient One", 2,6, 148, 72, 35, 0, 33.6, 0.627, 50, 1),
  //   createData("Patient Two", 3,6, 148, 72, 35, 0, 33.6, 0.627, 50, 1),
  //   createData("Patient Zero", 1,6, 148, 72, 35, 0, 33.6, 0.627, 50, 1),
  //   createData("Patient One", 2,6, 148, 72, 35, 0, 33.6, 0.627, 50, 1),
  //   createData("Patient Zero", 1,6, 148, 72, 35, 0, 33.6, 0.627, 50, 1),
  //   createData("Patient One", 2,6, 148, 72, 35, 0, 33.6, 0.627, 50, 1),
